package com.xiaocai.usefuldemo.app.constants;
...
/**
 * 作者：crr on 2016/4/21 0021 18:50
 * desc：
 */
public class ConfigConstants {
    ...
    //设置缓存放置的位置
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "xiaocai/imagepipeline_cache";//小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "xiaocai/imagepipeline_cache";//默认图所放路径的文件夹名
